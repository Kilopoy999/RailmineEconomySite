...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-ваш-секретный-ключ-для-разработки')
...
# Автоматически добавляем Render хост
...
# CSRF настройки для Render
CSRF_TRUSTED_ORIGINS = ['http://localhost:8000', 'http://127.0.0.1:8000']
if RENDER_EXTERNAL_HOSTNAME:
    CSRF_TRUSTED_ORIGINS.append(f'https://{RENDER_EXTERNAL_HOSTNAME}')

# Настройки сессий
SESSION_COOKIE_SECURE = not DEBUG  # True на продакшене
CSRF_COOKIE_SECURE = not DEBUG     # True на продакшене
